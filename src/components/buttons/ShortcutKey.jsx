...
const ShortcutKey = ({ children, css }) => {
  ...
  return (
    <Flex css={{ backgroundColor: `${theme?.primaryColor}`, borderRadius: '$round', height: '24px', width: '24px', ...css }} alignItems="center" justifyContent="center" className="shortcut-key-wrapper">
