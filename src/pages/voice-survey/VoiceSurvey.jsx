...
const AudioVisualizer = () => {
  ...
  return (
    <Box className="container" css={{ '&, & > canvas': { width: '100%', height: '100%', maxWidth: '100%', maxHeight: '100%' } }}>
  ...
  return (
    <Box css={{ marginTop: '20px', width: '100%' }}>
      <Flex alignItems="center" justifyContent="center">
        <Text size="xs" css={{ color: '$neutral800', textAlign: 'center', marginRight: '10px' }}>
          {status}
        </Text>
        {showLoader && <Box className="loader" css={{ scale: '0.25' }}></Box>}
        <Text size="xs" css={{ color: '$neutral800', textAlign: 'center', marginLeft: '10px' }}>
      ...
      <Flex alignItems="center" justifyContent="center" css={{ marginTop: '30px' }} gap="$16">
        <Box>
          <IconButton 
            icon={<MicIcon />} 
            size="md" 
          ...
          />
          <Text size="xxs" css={{ color: '$neutral700', textAlign: 'center', marginTop: '4px' }}>
            {isMuted ? 'Unmute' : 'Mute'}
          </Text>
        </Box>
        <Box>
          <IconButton 
            ...
            css={{
              borderRadius: '$round', 
              '&, &:hover, &:focus, &:active': { backgroundColor: '#DC2625 !important' },
...
const MicIcon = ({ size = 24, color = 'currentColor' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill={color} height={size} width={size} viewBox="0 0 24 24" className="magnet-button-icon shrink-0 w-6 h-6"><path fillRule="evenodd" d="M8 5a4 4 0 1 1 8 0v7a4 4 0 0 1-8 0V5Zm5 13.928A7.001 7.001 0 0 0 19 12a1 1 0 1 0-2 0 5 5 0 1 1-10 0 1 1 0 1 0-2 0 7 7 0 0 0 6 6.928V21H9a1 1 0 1 0 0 2h6a1 1 0 1 0 0-2h-2v-2.072Z" clipRule="evenodd"></path></svg>
  )
}
  ...
  return (
    <Button
      ...
      css={{
        ...
        '&:hover': { scale: '1.03' },
        '&:active': { scale: '1.01' },
        '&, &:hover, &:focus, &:active': { backgroundColor: `${accentColor} !important`, color: primaryColor }
      }}
...
const VoiceIcon = ({ size = 24, color = 'currentColor' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} width={size} fill={color} viewBox="0 0 24 24" className="magnet-button-icon shrink-0 w-5 h-5">
      <path fillRule="evenodd" d="M9.5 4a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V4ZM2 11a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-6Zm17-4.5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-10a2 2 0 0 0-2-2h-1Z" clipRule="evenodd">
      </path>
    </svg>
  )
}